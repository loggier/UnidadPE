    ...
    <Card className="shadow-xl">
      <CardContent className="p-2 sm:p-3 flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex-1">
          <h1 className="font-bold text-foreground tracking-wide leading-tight" style={{ fontSize: '48px' }}>{routeInfo.routeName}</h1>
          <p className="leading-tight" style={{ fontSize: '48px' }}>
            <span className="font-bold">Despacho:</span> <span className="font-bold text-foreground">{despachoString}</span>
          </p>
          <div className="flex items-baseline gap-4" style={{ fontSize: '48px' }}>
